...
every module in the `doppel.scanners` package so that dropping a new file
...
from doppel.core.models import Endpoint, Finding
...
def discover_scanners(package: str = "doppel.scanners") -> None:
