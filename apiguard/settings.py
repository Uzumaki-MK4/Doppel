...
so `apiguard scan --dry-run` needs no config file. Environment variables prefixed
`APIGUARD_` can override top-level fields; full env precedence over YAML is a
later refinement.
"""
